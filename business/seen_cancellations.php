...
/*
  ✅ Olvasottnak jelölés (appointments nélkül!)
  - csak a saját bookingjai
  - csak amik le vannak mondva (cancelled_at IS NOT NULL)
  - csak amik még nincsenek olvasva (provider_seen=0)
*/
$up = $mysqli->prepare("
  UPDATE bookings
  SET provider_seen = 1
